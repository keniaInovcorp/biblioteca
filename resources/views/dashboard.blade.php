        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body items-center text-center py-16">
                    ...
                    <h2 class="card-title text-3xl mb-2">Bem-vindo à Biblioteca!</h2>
                    <p class="text-base-content/70 mb-6 max-w-md">
                        Gerencie os seus livros, autores e editoras de forma simples e eficiente.
                    </p>
                    <div class="card-actions gap-2">
                        ...
                        <a href="{{ route('publishers.index') }}" class="btn btn-outline">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
