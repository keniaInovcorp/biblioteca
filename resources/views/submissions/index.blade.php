<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('success'))
                <div class="alert alert-success mt-4" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)">
            ...
            @if (session('error'))
                <div class="alert alert-error mt-4" x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)">
                    <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
